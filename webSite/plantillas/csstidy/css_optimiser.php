...
document.oncontextmenu = function(){return false}
  ...
  <body onload="enable_disable_preserve()">
    ...
    <?php //echo $lang[$l][39]; ?><!--: <a hreflang="en" href="?lang=es">Español</a> <a hreflang="en" href="?lang=en">English</a> <a hreflang="de" href="?lang=de">Deutsch</a> <a hreflang="fr" href="?lang=fr">French</a> <a hreflang="zh" href="?lang=zh">Chinese</a>--></p>
    <p><?php echo $lang[$l][4]; ?>
      <?php echo $lang[$l][6]; ?> <?php echo $lang[$l][2]; ?> csstidy <?php echo $css->version; ?>)
    </p>

    <form method="post" action="">
      <div>
        <fieldset style="margin-left:8px" id="field_input">
          <legend><?php echo $lang[$l][8]; ?></legend> <label for="css_text"
          class="block"><?php echo $lang[$l][9]; ?></label><textarea id="css_text" name="css_text" rows="20" cols="30"><?php if(isset($_REQUEST['css_text'])) echo htmlspecialchars($_REQUEST['css_text']); ?></textarea>
        ...
        <div id="rightcol">
          <fieldset id="code_layout">
            ...
            name="custom" cols="33" rows="2"><?php
